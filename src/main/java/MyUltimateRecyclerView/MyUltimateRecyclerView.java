...
package MyUltimateRecyclerView;
 ...
 */
public class MyUltimateRecyclerView extends FrameLayout implements Scrollable {
    ...
    public MyUltimateRecyclerView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initAttrs(attrs);
        initViews();
    }

    public MyUltimateRecyclerView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void initViews() { ///ANOTATIONS HERE!!!!!
        LayoutInflater inflater = (LayoutInflater) getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View view = inflater.inflate(R.layout.ultimate_recycler_view_layout, this); //Annotation Use My custom view instead
     ...
     */
    protected void setScrollbars() { //ANOTATIONS HERE!!!!!
        LayoutInflater inflater = (LayoutInflater) getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        switch (mScrollbarsStyle) {
            case SCROLLBARS_VERTICAL:
                ...
                mRecyclerView = (ObservableRecyclerView) verticalView.findViewById(R.id.ultimate_list);
                break;
            case SCROLLBARS_HORIZONTAL:
                ...
                mRecyclerView = (ObservableRecyclerView) horizontalView.findViewById(R.id.ultimate_list);
                break;
            default:
                break;
        }
    ...
    protected void initAttrs(AttributeSet attrs) {
        TypedArray typedArray = getContext().obtainStyledAttributes(attrs, com.marshalchen.ultimaterecyclerview.R.styleable.UltimateRecyclerview);

        try {
            mPadding = (int) typedArray.getDimension(com.marshalchen.ultimaterecyclerview.R.styleable.UltimateRecyclerview_recyclerviewPadding, -1.1f);
            mPaddingTop = (int) typedArray.getDimension(com.marshalchen.ultimaterecyclerview.R.styleable.UltimateRecyclerview_recyclerviewPaddingTop, 0.0f);
            mPaddingBottom = (int) typedArray.getDimension(com.marshalchen.ultimaterecyclerview.R.styleable.UltimateRecyclerview_recyclerviewPaddingBottom, 0.0f);
            mPaddingLeft = (int) typedArray.getDimension(com.marshalchen.ultimaterecyclerview.R.styleable.UltimateRecyclerview_recyclerviewPaddingLeft, 0.0f);
            mPaddingRight = (int) typedArray.getDimension(com.marshalchen.ultimaterecyclerview.R.styleable.UltimateRecyclerview_recyclerviewPaddingRight, 0.0f);
            mClipToPadding = typedArray.getBoolean(com.marshalchen.ultimaterecyclerview.R.styleable.UltimateRecyclerview_recyclerviewClipToPadding, false);
            mEmptyId = typedArray.getResourceId(com.marshalchen.ultimaterecyclerview.R.styleable.UltimateRecyclerview_recyclerviewEmptyView, 0);
            mFloatingButtonId = typedArray.getResourceId(com.marshalchen.ultimaterecyclerview.R.styleable.UltimateRecyclerview_recyclerviewFloatingActionView, 0);
            mScrollbarsStyle = typedArray.getInt(com.marshalchen.ultimaterecyclerview.R.styleable.UltimateRecyclerview_recyclerviewScrollbars, SCROLLBARS_NONE);
            int colorList = typedArray.getResourceId(com.marshalchen.ultimaterecyclerview.R.styleable.UltimateRecyclerview_recyclerviewDefaultSwipeColor, 0);
            if (colorList != 0) {
    ...
    public void enableLoadmore() {
        ...
        if (mAdapter != null && mAdapter.getCustomLoadMoreView() == null)
            mAdapter.setCustomLoadMoreView(LayoutInflater.from(getContext())
                    .inflate(com.marshalchen.ultimaterecyclerview.R.layout.bottom_progressbar, null));
    }
    ...
    public void disableLoadmore() {
        ...
        mAdapter.swipeCustomLoadMoreView(LayoutInflater.from(getContext())
                .inflate(com.marshalchen.ultimaterecyclerview.R.layout.empty_progressbar, null));
    }
...
//
    ...
    private com.marshalchen.ultimaterecyclerview.UltimateRecyclerView.CustomRelativeWrapper mHeader;
...
//        return super.onInterceptTouchEvent(ev);
    ...
    @Deprecated
    public void showToolbarAndFAB(Toolbar mToolbar, MyUltimateRecyclerView ultimateRecyclerView, int screenHeight) {
        showToolbar(mToolbar, ultimateRecyclerView, screenHeight);
        showDefaultFloatingActionButton();
    }

    @Deprecated
    public void hideToolbarAndFAB(Toolbar mToolbar, MyUltimateRecyclerView ultimateRecyclerView, int screenHeight) {
        hideToolbar(mToolbar, ultimateRecyclerView, screenHeight);
        hideDefaultFloatingActionButton();
    }

    public void showToolbar(Toolbar mToolbar, MyUltimateRecyclerView ultimateRecyclerView, int screenHeight) {
        moveToolbar(mToolbar, ultimateRecyclerView, screenHeight, 0);
    }

    public void hideToolbar(Toolbar mToolbar, MyUltimateRecyclerView ultimateRecyclerView, int screenHeight) {
        moveToolbar(mToolbar, ultimateRecyclerView, screenHeight, -mToolbar.getHeight());
    }

    public void showView(View mView, MyUltimateRecyclerView ultimateRecyclerView, int screenHeight) {
        moveView(mView, ultimateRecyclerView, screenHeight, 0);
    }

    public void hideView(View mView, MyUltimateRecyclerView ultimateRecyclerView, int screenHeight) {
        moveView(mView, ultimateRecyclerView, screenHeight, -mView.getHeight());
    }

    protected void moveToolbar(final Toolbar mToolbar, final MyUltimateRecyclerView ultimateRecyclerView, final int screenheight, float toTranslationY) {
    ...
    protected void moveView(final View mView, final MyUltimateRecyclerView ultimateRecyclerView, final int screenheight, float toTranslationY) {
