...
import CustomYouTubePlayer.AudioUtil;
import CustomYouTubePlayer.Orientation;
import CustomYouTubePlayer.StatusBarUtil;
import CustomYouTubePlayer.YouTubeUrlParser;
import CustomYouTubePlayer.YouTubeUtil;
...
public class YouTubePlayerActivity extends YouTubeBaseActivity implements
    ...
    public static final String META_DATA_NAME = "ApiKey";
                        ...
                        if (distance > MIN_DISTANCE) {
                            ...
                            if (x2 > x1) {
                                if (estimatedTime > 5000) {
                                    Toast.makeText(getApplicationContext(), "Back 20 secs ", Toast.LENGTH_SHORT).show();
                                    player.seekRelativeMillis(-20000);
                                } else if (estimatedTime > 3000 && estimatedTime < 5000) {
                                    Toast.makeText(getApplicationContext(), "Back 15 secs ", Toast.LENGTH_SHORT).show();
                                    player.seekRelativeMillis(-15000);
                                } else if (estimatedTime < 3000) {
                                    Toast.makeText(getApplicationContext(), "Back 5 secs ", Toast.LENGTH_SHORT).show();
                            ...
                            // Right to left swipe action
                                ...
                                if (estimatedTime > 5000) {
                                    Toast.makeText(getApplicationContext(), "Skip 20 secs ", Toast.LENGTH_SHORT).show();
                                    player.seekRelativeMillis(20000);
                                } else if (estimatedTime > 3000 && estimatedTime < 5000) {
                                    Toast.makeText(getApplicationContext(), "Skip 15 secs ", Toast.LENGTH_SHORT).show();
                                    player.seekRelativeMillis(15000);
                                } else if (estimatedTime < 3000) {
                                    Toast.makeText(getApplicationContext(), "Skip 5 secs ", Toast.LENGTH_SHORT).show();
                                    player.seekRelativeMillis(5000);
                                }
                            }
                        } else {
